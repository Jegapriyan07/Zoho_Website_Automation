...
>
> **Writer brief:** Zoho **Writer API** only (`extractWriterViaApi`). Never Chrome MCP / Puppeteer for Writer docs. API auth fail → hard stop — Sign in with Zoho in the Web Page Builder.
...
| `section-composites.json` | Multi-section archetypes (dashboard-examples, agency landings, BI guide, spreadsheet, …) |
...
| `briefs/{slug}.txt` | Written by **Writer API** extract (`extraction_method: writer_api`) |
